...
<section class="section">
    <div class="container">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: start;">
            <div>
                <h2>Get In Touch</h2>
                <p style="margin-bottom: 2rem;">Whether you have questions about our tables, want a custom quote, or just want to chat about poker, we're here to help.</p>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <p style="color: var(--gray-600);">(555) 123-4567</p>
                </div>
                ...
                <div>
                    ...
                    <p style="color: var(--gray-600);">Monday - Friday: 9am - 6pm<br>Saturday: By appointment<br>Sunday: Closed</p>
                </div>
            </div>
                        ...
                        <form method="POST" action="" data-validate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" class="form-control"
                                       value="<?= sanitize($_POST['name'] ?? (isLoggedIn() ? $_SESSION['user_name'] : '')) ?>" required>
                            </div>

                            <div class="form-group">
                                <label class="form-label" for="email">Email Address</label>
                                <input type="email" id="email" name="email" class="form-control"
                                       value="<?= sanitize($_POST['email'] ?? (isLoggedIn() ? $_SESSION['user_email'] : '')) ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="subject" name="subject" class="form-control">
                                    ...
                                    <option value="Custom Table Quote">Custom Table Quote</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="message" name="message" class="form-control" rows="5" required><?= sanitize($_POST['message'] ?? '') ?></textarea>
                            </div>
