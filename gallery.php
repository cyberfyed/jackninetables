        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(350px, 1fr)); gap: 2rem;">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p style="color: var(--gray-600);">96" oval with racetrack rail, suited speed cloth, black vinyl rail with 10 stainless steel cup holders.</p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h3>Midnight Blue</h3>
                    <p style="color: var(--gray-600);">108" oval with racetrack, navy speed cloth, matching navy rail with dealer cutout.</p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h3>Ruby Red</h3>
                    <p style="color: var(--gray-600);">84" oval standard rail, red velveteen surface, burgundy vinyl rail, perfect for home games.</p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h3>Royal Purple</h3>
                    <p style="color: var(--gray-600);">96" oval with racetrack, purple speed cloth, black rail with gold accents and 10 cup holders.</p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p style="color: var(--gray-600);">108" oval with racetrack, black suited speed cloth, black rail for a sleek, modern look.</p>
                </div>
            </div>

            <div class="card">
                <div style="background: linear-gradient(135deg, #2d5a3d 0%, #3d7a5d 100%); height: 250px; display: flex; align-items: center; justify-content: center; color: white; font-size: 4rem;">
                    &#127183;
                </div>
                <div class="card-body">
                    <h3>Tournament Pro</h3>
                    <p style="color: var(--gray-600);">108" with dealer cutout, casino green speed cloth, brown leather rail, professional grade.</p>
                </div>
            </div>
        </div>
